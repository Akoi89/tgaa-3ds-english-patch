...
**Second game's title logo, restored on 7 September.** The first `TGAA2-base-1.0.16.cia` uploaded here, and v1.5 before it, drew the fan-made title logo on the second game's title screen instead of Capcom's colour *Resolve* logo that v1.4 had. The version stamp had been repainted onto the wrong source picture. The update CIA, its xdelta zip and both Japanese-voice zips were replaced in place with that one texture corrected; nothing else in them changed, and the version numbers stay the same. If your second game's title screen shows a plain cream logo with a long Japanese-style subtitle, reinstall the update.
