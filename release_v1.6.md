...
- Both games install and boot on a real 3DS, and the patch route in the zips was walked on a New 3DS from a clean install. The second game's DLC has been played through on hardware twice; the base games have not.
