...
| 2 | `TGAA1-base-3.3.7.cia` / `TGAA2-base-1.0.21.cia` | the update |
| 3 | `TGAA1-DLC-1.0.17.cia` / `TGAA2-DLC-1.0.13.cia` | the DLC |
| 4 | `TGAA1-3DS-English-v1.9e-xdelta.zip` / `TGAA2-3DS-English-v1.9e-xdelta.zip` | optional: rows 2 and 3 as xdelta patches against your own decrypted dump, plus the HOME banner patch and a readme |
...
`TGAA1-README-v1.9e.txt` and `TGAA2-README-v1.9e.txt` on the release page are the readmes from
...
| | reads |
|---|---|
| TGAA1 title screen, top right | `ENG 3.3.7` |
| TGAA1 DLC, Episode 0 magazine cover | `DLC 1.0.17`, top left |
| TGAA2 title screen, top right | `ENG 1.0.21` |
