...
GAMES = {
    'TGAA1': dict(B.GAMES['TGAA1'], update=r'jpvoice\_out\TGAA1-base-3.2.2-jpvoice.cia', dlc=r'jpvoice\_out\TGAA1-DLC-1.0.10-jpvoice.cia'),
    'TGAA2': dict(B.GAMES['TGAA2'], update=r'jpvoice\_out\TGAA2-base-1.0.15-jpvoice.cia', dlc=r'jpvoice\_out\TGAA2-DLC-1.0.9-jpvoice.cia'),
}
rows = []
