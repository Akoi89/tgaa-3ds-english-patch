...
SRC = {
    'TGAA1': dict(
        ours_upd=os.path.join(ROOT, 'Final', FINAL, 'TGAA1-base-3.3.2.cia'),
        ours_dlc=os.path.join(ROOT, 'Final', FINAL, 'TGAA1-DLC-1.0.16.cia'),
    ...
    'TGAA2': dict(
        ours_upd=os.path.join(ROOT, 'Final', FINAL, 'TGAA2-base-1.0.17.cia'),
        ours_dlc=os.path.join(ROOT, 'Final', FINAL, 'TGAA2-DLC-1.0.11.cia'),
